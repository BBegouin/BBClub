# -*- coding: utf-8 -*-
# Generated by Django 1.9.2 on 2016-09-19 15:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icon_file_path', models.CharField(blank=True, max_length=500, null=True)),
                ...
                ('ref_roster', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='roster', to='league_manager.Ref_Roster')),
            ],
        ),
        migrations.CreateModel(
            name='Team_Report',
        ...
        migrations.AddField(
            model_name='ref_roster_line',
            name='roster',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='roster_lines', to='league_manager.Ref_Roster'),
        ),
        migrations.AddField(
